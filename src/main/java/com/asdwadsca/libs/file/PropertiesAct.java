...
public class PropertiesAct {
    ...
    /**
     *  全局常量,确保方法调用时不会文件写入只有一行
     */
    private static final Properties PROPERTIES = new Properties();


    /**
     * 该方法接受文件目录和文件名,并处理为合法文件文件路径,并安装路径创建文件
     * 该方法无返回值
     * 该方法会抛出IOException异常
     *
     ...
     */
    public static void createFile(String file_path, String file_name) throws IOException{
    ...
    /**
     * 该方法接受文件目录,文件名和键值对, 并将接受的文件目录和文件名处理为合法文件路径,并按照接受的键值对修改文件
     * 该方法无返回值
     * 该方法会抛出IOException异常
     *
     * @param file_path     文件的目录
    ...
    /**
     * 该方法接受文件目录,文件名和键, 并将接受的文件目录和文件名处理为合法文件路径, 按照接受的键查询对应的值
     * 该方法返回String类型的值
     * 该方法会抛出IOException异常
     *
     * @param file_path     文件的目录
    ...
    /**
     * 该方法接受文件目录,文件名, 并将接受的文件目录和文件名处理为合法文件路径, 按照处理后的文件路径删除文件
     * 该方法无返回值
     * 该方法不抛出异常
     *
     * @param file_path     文件的目录
